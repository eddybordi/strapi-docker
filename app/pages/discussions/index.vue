<template>
  <div class="w-full max-1280 m-auto p-3">
    <PostsCat></PostsCat>
    <div class="all flex mt-2">
      <div class="left w-3/5">
        <div class="element text-lg font-medium px-3 py-2 text-center">
          Dernières discussions
        </div>
        <div class="posts mt-2">
          <div class="post rounded mb-3" v-for="post in [1,1,1,1]">
            <div class="title text-lg italic p-3">Ceci est un test, je manque grandement d'inspiration pour mes phrases de tests, alors voilà, j'écris n'importe quoi afin que ça fasse au moins deux lignes pour tester le texte tronqué sur deux lignes</div>
            <div class="user flex items-center mt-2 px-3 py-2">
